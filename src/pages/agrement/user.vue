<template lang="pug">
    #user-agrement.body-main
       h1.text-color-1 用户协议
       .info.text-color-2 BtcFoo Global Limited.（以下称 “公司”）是一家根据英属维尔京群岛相关法律在英属维尔京群岛注册成立的公司，该公司运营网站https://www.btcfoo.com（以下称“本网站”或“网站”），该网站是一个专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。
        br
        br  
        | 重要提示：
        br
        ...
        br
        br
        | &nbsp;5. https://www.btcfoo.com/为本网站唯一官方对外信息公布平台；
        br
        br
        | &nbsp;6. 本网站任何服务均不接受信用卡支付；
        br
        ...
        br
        br
        | 11.2.1.10 邀请您参与有关本网站服务的调查；&nbsp;
        br
        br
        | 11.2.1.11 用于和政府机关、公共事务机构、协会等合作的数据分析；&nbsp;
        br
        br
        | 11.2.1.12 用作其他一切合法目的以及经您授权的其他用途。&nbsp;
        br
        br
        ...
        br
        br
        | 您理解并承认，根据英属维尔京群岛相关法律，您不得将本网站上的任何材料（包括软件）出口、再出口、进口或转移，故您保证不会主动实施或协助或参与任何上述违反法规的出口或有关转移或其他违反适用的法律和法规的行为；如发现此类情形，会向我们积极报告并协助我们处理。
        br
        br
        | 十四、转让
        br
        ...
        br
        br
        | 本协议全部内容均为根据英属维尔京群岛法律订立的合同，其成立、解释、内容及执行均适用英属维尔京群岛相关法律规定；任何因或与本协议约定的服务有关而产生的索赔或诉讼，都应依照英属维尔京群岛的法律进行管辖并加以解释和执行。为避免疑义，这一条款明确适用
        br
        br
</template>
<style lang="less">
